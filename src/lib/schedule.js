...
/* 단계 표시는 검정 농도만 쓴다(강조색 규칙 2026-09-21). 단계 이름이 늘 글자로 붙으므로 색은 장식이고,
   색 네 가지를 쓰면 민트가 '추천'이라는 뜻을 잃는다. 농도는 진한 것부터 옅은 것 순이다. */
export const STEP_COLORS = ['#17182a', '#414257', '#6e6f85', '#9a9bae']; // 준비·가입·구독 정리·완료
