...
const QUALITY = [
  ...
  ['nonMonthlyTiers', '월 단가가 아닌 등급', '등급 이름에 기간 표기(개월·연간·N년)가 있거나, 같은 서비스 중앙값의 10배가 넘는 등급. 비고는 보지 않는다 — 우리가 쓴 설명문이라 기간 낱말이 섞인다. 큰 값이 다 틀린 건 아니다 — iCloud+ 12TB 처럼 진짜 비싼 월 상품도 걸린다'],
];
